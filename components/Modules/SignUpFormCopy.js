    ...
    return (
        <Form layout="vertical" form={form} name="signup" onFinish={onFinish} scrollToFirstError requiredMark={false}>
            <div style={{ display: 'flex' }}>
                <Form.Item name="username" label="아이" rules={[{ validator: validateUsername }]}>
            ...
            <div style={{ display: 'flex' }}>
                <Form.Item
                    name="email"
                    label="E-mail"
                    rules={[{ validator: validateEmail }, { validator: ckeckDuplicateEmail, validateTrigger: 'onBlur' }]}
                >
                    <Input style={inputBoxStyle} />
                </Form.Item>
            </div>
            ...
            <Button onClick={formErrorCheck}>check</Button>{' '}
        </Form>
    );
};
